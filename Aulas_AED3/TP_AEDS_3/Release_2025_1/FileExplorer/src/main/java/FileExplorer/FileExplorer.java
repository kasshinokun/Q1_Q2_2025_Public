    ...
    public static void get_FolderPath(String userP, String[] args){//Obter caminho para inicar buscar de arquivo    
        ...
        switch(op){
            case 1:
                ...
                chooseFiles(userP.concat(sep+folder),".txt");
...
//Caminho e Arquivos---------------------------------------------------------------------------------------------
    ...
    private static void chooseFiles(String folderPath,String extension){
        ...
        if(tamanho!=0){//Se não for empty ou null object
            ...
            if (choice>-1&&choice<tamanho){//se dentro do escopo inicia o processo
                ...
                try{
                    ...
                    FileReader.read_file2(pathFile);//Erro corrigido 12442 registros
                    //Erro para estudar: java.lang.ArrayIndexOutOfBoundsException: Index 1 out of bounds for length 1
                }catch (IOException e) {
                    System.err.printf("Erro na abertura do arquivo: %s.\n",
                      e.getMessage());
                }
                
                //Adiciona a um vetor de objeto
                
                //Envia o vetor ou escreve em arquivo
