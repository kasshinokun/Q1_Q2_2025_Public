package Encrypt.aes_c.old;//Nome do Subprojeto
...
//=====================================================================Demais Variaveis AES-256===================================================================================================
    ...
    static byte[] key= {(byte)0x2b,(byte)0x7e,(byte)0x15,(byte)0x16,(byte)0x28,(byte)0xae,(byte)0xd2,(byte)0xa6,(byte)0xab,(byte)0xf7,(byte)0x15,(byte)0x88,(byte)0x09,(byte)0xcf,(byte)0x4f,(byte)0x3c};
    ...
    */
    ...
    static int Nb=4;// The number of columns comprising a state in AES. This is a constant in AES. Value=4
	
	static int Nk=0;// The number of 32 bit words in a key
	
	static int Nr=0;// The number of rounds in AES Cipher

//=====================================================================Processos AES-256 A========================================================================================================
	public static void setNK(int AES_Code) {//Setting Rounds
		if (AES_Code==256) {
			Nk=8;        // The number of 32 bit words(8) in a key.
	        Nr=14;       // The number of rounds(14) in AES Cipher 256 bits
		}    
		else if (AES_Code==192){
			Nk=6;        // The number of 32 bit words(6) in a key.
			Nr=12;       // The number of rounds(12) in AES Cipher 192 bits
		}else if(AES_Code==128){
			Nk=4;        // The number of 32 bit words(4) in a key.
	    	Nr=10;       // The number of rounds(10) in AES Cipher 128 bits
		}else {
			Nk=-1;
			Nr=-1;
		}
