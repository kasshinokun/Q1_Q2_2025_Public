...
import test.*;
import test.estagio1.DataObject;
import test.estagio1.DeleteProcess;
import test.estagio1.Functions;
...
public class EscritorUpdateArquivo {
	...
	public static DataObject newObject(DataObject obj)throws IOException{
		...
		if(obj.getID_registro()==0) {
			...
			int ID=LeitorArquivo.getHeader("traffic_accidents.db");
