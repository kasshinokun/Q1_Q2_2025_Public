...
# Blowfish Initialization Constants (from Pi hex digits)
P_INIT = [
...
def derive_key(password, salt, dk_len=16, iterations=10000):
    return hashlib.pbkdf2_hmac('sha256', password, salt, iterations, dk_len)
...
def encrypt_file(input_file, output_file, password):
    ...
    # Prepend IV to plaintext for CBC
