...
def view_all_records(db: TrafficAccidentsDB):
    ...
    if st.session_state.reset_view_all_filters:
        ...
        st.session_state.view_page_size = 20 # Default to 20
        st.session_state.view_page_num = 1 # Default to page 1
        st.session_state.reset_view_all_filters = False # Reset the flag
    ...
    with page_cols[0]:
        page_size = st.selectbox(
            ...
            index=[10, 20, 50, 100, total_records_in_db].index(st.session_state.view_page_size) if st.session_state.view_page_size in [10, 20, 50, 100, total_records_in_db] else 1, # Default to 20 per page, persist
            key="view_page_size"
        )
